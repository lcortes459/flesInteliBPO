                    ...
                    <div style="float: right;">
                    	<div class="row">
                    		<div class="nav-item col-sm-12 col-md-12">
                        		<button class="btn btn-block btn-secondary" id="idBtnRegresarProyectos"  type="button" onclick="pro.regresarProyectos('nuevoProyecto','listadoProyectos',`+idCliente+`,'`+title+`');">
                    ...
                    <div style="float: right;">
                    	<div class="row">
                    		<div class="nav-item col-sm-6 col-md-6">
                        		<button class="btn btn-block btn-secondary" id="idBtnRegresarListado" type="button" onclick="pro.terminar();">
                        			<i class="fas fa-backward"></i>
                        		</button>
                        	</div>
                        	<div class="nav-item col-sm-6 col-md-6">
                        		<button class="btn btn-block btn-primary" id="idBtnRegresarListado" type="button" onclick="pro.nuevoProyecto('listadoProyectos','nuevoProyecto',`+idCliente+`,'`+title+`');">
		...
		$('#'+divHide+'').hide('slow/400/fast', function() {
			...
			$('#'+divShow+'').show('slow/400/fast', function() {
				var header = `
                    ...
                    <div style="float: right;">
                        <button class="btn btn-block btn-primary" id="idBtnRegresarListado" type="button" onclick="pro.terminar();">Regresar Listado De Clientes</button>
                    </div>
				`;
				$('#cardHeaderPrincipal').html(header);
		...
		$('#'+divHide+'').hide('slow/400/fast', function() {
			...
			$('#'+divShow+'').show('slow/400/fast', function() {
				...
				$('#btnNuevoPredioDiv').html(`
					<button class="btn btn-block btn-primary" id="idBtnRegresarListado" type="button" onclick="pro.nuevoPredio('predios','nuevoPredio',`+idArea+`);">
                        <i class="fas fa-plus"></i>
                    </button>
				`);
		            	...
		            	toastr.success('Felicidades.', ''+nombreCliente+' bloqueado con éxito.', { timeOut: 3000 }, toastr.options.onHidden = function() {
		            		...
		            		$('#idTdProyecto_'+idCliente).html(`
								<span 
									...
									onclick="pro.cambioEstado(`+idCliente+`, '`+nombreCliente+`',1);">
									Bloqueado
								</span>
		            	...
		            	toastr.success('Felicidades.', ''+nombreCliente+' activado con éxito.', { timeOut: 3000 }, toastr.options.onHidden = function() {
		            		...
		            		$('#idTdProyecto_'+idCliente).html(`
								<span 
									...
									id="spanEstado_proyecto_`+idCliente+`" 
									style="cursor:pointer;" 
									onclick="pro.cambioEstado(`+idCliente+`,' `+nombreCliente+`',0);">
									Activo
								</span>
		...
		$('#'+divHide+'').hide('slow/400/fast', function() {
			...
			$('#'+divShow+'').show('slow/400/fast', function() {
				var header = `
                    ...
                    <div style="float: right;">
                        <button class="btn btn-block btn-secondary" id="idBtnRegresarListadoProyectos" type="button" onclick="pro.regresarProyecto('`+divShow+`','`+divHide+`','Listado Proyectos','`+nombreCliente+`','`+idCliente+`');">
                			<i class="fas fa-backward"></i>
                		</button>
                    </div>
				`;
				...
				var header = `
                    ...
                    <!--div style="float: right;">
                    	<div class="row">
                        	...
                        	<div class="nav-item col-sm-6 col-md-6">
                        		<button class="btn btn-block btn-primary" id="idBtnRegresarListado" type="button" onclick="pro.nuevoProyecto('listadoProyectos','nuevoProyecto',`+idCliente+`,'Listado Proyectos(`+nombreCliente+`)');">
                        			<i class="fas fa-plus"></i>
                        		</button>
                        	</div>
                        </div>
